...
object VpnStateHolder {
    ...
    private var _vpnStatus : VpnStatus = VpnStatus("initialized", "unknown")

    init {
         _vpnStatus = VpnStatus("initialized", "initialized")
     }

    // 提供一个更新状态的方法
    fun updateStatus(newStatus: VpnStatus) {
        _vpnStatus = newStatus
    }

    fun getStatus() :String {
        return _vpnStatus.status
    }
}